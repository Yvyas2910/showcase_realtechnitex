  ...
  return (
    <React.Fragment>
      <div style={{ minHeight: "90vh" }}>
        ...
        <p className="text-muted p-0 m-0 text-center">(non woven bag)</p>
                    ...
                    <li className="d-flex pt-1 align-items-top">
                      <div className={"text-center"}>
                        <Select
                          ...
                          bordered={false}
                          onChange={(value) =>
                            handleChangeStatus(bagOrder._id, value)
                          }
                          defaultValue={bagOrder?.status}
                        >
                          {status.map((s, i) => (
