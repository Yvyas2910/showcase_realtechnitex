...
const CompletedOrders = () => {
  ...
  const pendingBagOrdersCount = countBagOrdersByStatus("Pending");
  const pendingFabricOrdersCount = countFabricOrdersByStatus("Pending");
    ...
    <React.Fragment>
      <div style={{ minHeight: "60vh" }}>
        ...
        <div className="my-5 mx-2 justify-content-center align-items-center">
          <div className="border mb-4 py-2 shadow-sm rounded-3 bg-warning bg-opacity-25">
            <p className="text-center mb-0 fw-semibold">
              Pending Bag Orders :{" "}
              <span className="px-2 py-1 text-light bg-primary rounded-3">
                {pendingBagOrdersCount}
              </span>
            </p>
          ...
          <div className="border mb-4 py-2 shadow-sm rounded-3 bg-warning bg-opacity-25">
            <p className="text-center mb-0 fw-semibold">
              Pending Fabric Orders :{" "}
              <span className="px-2 py-1 text-light bg-primary rounded-3">
                {pendingFabricOrdersCount}
              </span>
            </p>
            {/* <div className="fs-5 text-center">
              <button className="btn btn-outline-dark">
