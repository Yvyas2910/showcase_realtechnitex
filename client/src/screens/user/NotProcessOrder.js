...
const NotProcessOrder = () => {
  ...
  const notProcessedBagOrdersCount = countBagOrdersByStatus("Not Process");
  const notProcessedFabricOrdersCount =
    countFabricOrdersByStatus("Not Process");
  return (
    <React.Fragment>
      <div style={{ minHeight: "60vh" }}>
        <Navbar />
        <div className="my-5 mx-2 justify-content-center align-items-center">
          <div className="border mb-4 py-2 shadow-sm rounded-3 bg-primary bg-opacity-25">
            <p className="text-center mb-0 fw-semibold">
              Not Processed Bag Orders :{" "}
              <span className="px-2 py-1 text-light bg-primary rounded-3">
                {notProcessedBagOrdersCount}
              </span>
            </p>
          ...
          <div className="border mb-4 py-2 shadow-sm rounded-3 bg-primary bg-opacity-25">
            <p className="text-center mb-0 fw-semibold">
              Not Processed Fabric Orders :{" "}
              <span className="px-2 py-1 text-light bg-primary rounded-3">
                {notProcessedFabricOrdersCount}
              </span>
            </p>
            {/* <div className="fs-5 text-center">
            <button className="btn btn-outline-dark">
...
export default NotProcessOrder;
